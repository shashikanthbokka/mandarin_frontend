        ...
        <div className="white-part">
          ...
          <div className="white-part-middle-hod">
            ...
            <select required>
              ...
              <option>Mechanichal Engineering</option>
            ...
            {/* <select required>
              ...
              <option>Purnachand K</option>
              <option>Krutibash Nayak</option>
              <option>Nikhila R</option>
              <option>Purnachandra Rao M</option>
              <option>Kiranmai R</option>
            </select> */}
